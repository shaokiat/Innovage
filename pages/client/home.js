      ...
      <div className="row justify-content-center">
                <div className="col-3">
                      <Link href="../financial_services">
                            <a className={styles.categoryLogo}> <HiUserGroup size={120} /> </a>
                      </Link>
                      <Link href="../financial_services">
                ...
                <div className="col-3">
                       <Link href="../account_bal">
                             <a className={styles.categoryLogo} target="_blank" rel="noreferrer"> <MdAccountCircle size={120} />  </a>
                         </Link>
                         <Link href="../account_bal">
                            <a className={styles.categoriesHeaders} target="_blank" rel="noreferrer"> Accounts </a>
                         </Link>
                  </div>
              
                  <div className="col-3">
                        <Link href="https://www.citibank.com.sg/SGGCB/JSO/username/signon/flow.action?ts=1660136063283">
                            <a className={styles.categoryLogo}> <FaBalanceScale size={120} />  </a>
                        </Link>
        ...
        <div className="row justify-content-center"> 
              <div className="col-3">
                      <Link href="../financial_tools">
                            <a className={styles.btmcategoryLogo}> <BiCalculator size={120} /> </a>
                      </Link>
                      <Link href="../financial_tools">
                ...
                <div className="col-3">
                      <Link href="../academy">
                           <a className={styles.btmcategoryLogo}> <HiOutlineAcademicCap size={120} /> </a>
                        </Link>
                  ...
                  <div className="col-3">
                       <Link href="https://t.me/onecity_client_bot">
                            <a className={styles.btmcategoryLogo}> <BiBot size={120} /> </a>
                        </Link>
